...
| < Xcode15 | < iOS13 / macOS11   | [0.3.3](https://github.com/duzhaoquan/CodableWrapper/tree/0.3.3) |
...
#### Cocoapods [Beta test](https://github.com/duzhaoquan/CodableWrapper/tree/1.1.0)
``` pod 'CodableWrapper', :git => 'https://github.com/duzhaoquan/CodableWrapper.git', :branch => '1.1.0' ```

#### Swift Package Manager
``` https://github.com/duzhaoquan/CodableWrapper ```
